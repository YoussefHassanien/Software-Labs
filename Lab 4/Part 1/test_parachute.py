...
class TestParachuteSystem(unittest.TestCase):
    ...
    def test_deploy_low_altitude(self):
    ...
    def test_is_safe_landing_succesful(self):
        self.assertEqual(ParachuteSytem.is_safe_landing(49,10), True)

    def test_is_safe_landing_failure(self):
        self.assertEqual(ParachuteSytem.is_safe_landing(50,10), False)
